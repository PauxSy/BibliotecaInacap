        ...
        if menu == 1:
            ...
            while True:
                ...
                if menu_3 == 1:
                    ...
                    print("Prestamo y devolución registrados exitosamente.")
        ...
        if menu == 1:
            ...
            while True:
                ...
                if menu_3 == 1:
                    ...
                    fecha_devolucion = Devoluciones.calcular_fecha_devolucion(nuevo_prestamo.rut_usuario, nuevo_prestamo.fecha_prestamo)
